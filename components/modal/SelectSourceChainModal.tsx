...
const SelectSourceChainModal = (props: SelectSourceChainModalProps) => {
          ...
          <DialogHeader className="flex items-center justify-center gap-3">
            ...
            <DialogDescription>
              <div className="grid grid-cols-2 items-center justify-center p-4 gap-x-8 gap-y-2">
                {networkList?.map((e) => (
                  <div
                    className={`flex items-center justify-center w-48 h-16 gap-3 rounded-3xl cursor-pointer font-semibold text-sm text-white bg-[#85A0FF]/70 
