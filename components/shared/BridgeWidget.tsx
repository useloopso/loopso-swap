...
import { constants } from "loopso-bridge-sdk";
...
const BridgeWidget = () => {
  ...
  console.log(constants, "Constansts from loopso bridge sdk");
      ...
      <div className="widget-content blue-pink-gradient">
        ...
        <div>
          <div className="swap-content">
            <div className="flex">
              <SelectTokenModal token={tokenOne} />
          ...
          <div className="items-center justify-center flex">
            <MoveDown className="bg-[#85A0FF]/70 rounded-xl p-2 h-9 w-9 border-2 border-slate" />
          </div>
          <div className="h-2"></div>
          <div className="swap-content">
            <div className="flex">
